  ...
  <div className="overflow-x-hidden">
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
        ...
        >
          High Integrity AFOLU Carbon Projects aligned with VCS, CCB Gold & SD VISta delivered through a PMBOK® aligned
          framework.
        </motion.p>
      ...
      {/* Gradient fade at bottom of hero into white */}
      <div
    ...
    <section className="bg-white py-16 md:py-20">
      ...
      >
        <p className="text-base md:text-lg text-black font-body tracking-wide max-w-4xl mx-auto">
    ...
    {/* Earth-friendly box */}
    <section id="earth-friendly" className="bg-white pb-20 md:pb-28">
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, margin: "-80px" }}
      ...
      >
        <div className="max-w-2xl w-full rounded-2xl border border-gray-200 bg-white p-8 md:p-10 text-center">
          <h2 className="text-2xl md:text-3xl font-display text-primary mb-6">Earth friendly!</h2>
          <p className="text-black text-sm md:text-base font-body leading-relaxed">
    ...
    <section className="bg-white pb-24 md:pb-32">
      ...
      >
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-display mt-3 text-black">Our Services</h2>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-4 sm:py-5 md:w-64 flex-shrink-0">
                  ...
                  <h3 className="font-display text-lg text-black group-hover:text-primary transition-colors">
                    {s.title}
                  </h3>
                </div>
                ...
                <div className="flex-1 flex items-center px-4 sm:px-6 pb-4 sm:pb-5 md:py-5">
                  <p className="text-black text-sm font-body leading-relaxed">{s.desc}</p>
                </div>

                {/* Arrow */}
                <div className="hidden md:flex items-center pr-6">
                  <ChevronDown
                    className="text-gray-400 group-hover:text-primary -rotate-90 transition-colors"
                    size={20}
                  />
                </div>
              </Link>
